...
import com.nikhil.trading.modal.*;
import com.nikhil.trading.repository.OrderItemRepository;
import com.nikhil.trading.repository.OrderRepository;
...
public class OrderServiceImpl implements OrderService {
    ...
    public Order buyAsset(Coin coin, double quantity, User user) throws Exception {
        ...
        walletService.handleBuySellOrder(order, user);
    ...
    @Transactional
    public Order sellAsset(Coin coin,double sellQuantity, User user) throws Exception {
        ...
        if (existingAsset != null) {
            ...
            OrderItem orderItem = createOrderItem(coin,sellQuantity, existingAsset.getBuyPrice(), sellPrice);
            ...
            if (existingAsset.getQuantity() >= sellQuantity) {
